...
class CrudProdutos {
    ...
    public function editar(Produto $produto){
        $this->conexao->exec("UPDATE tb_produtos SET = nome = '$produto->nome',preco = $produto->preco,categoria = '$produto->categoria',quantidade_estoque = $produto->estoque WHERE id = $produto->id;")
